...
//> inherit-self
    if (stmt.superclass != null &&
      ...
      Xmun.error(stmt.superclass.name,
...
//> return-from-top
    if (currentFunction == FunctionType.NONE) {
      Xmun.error(stmt.keyword, "Can't return from top-level code.");
    }
