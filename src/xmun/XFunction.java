...
class XFunction implements Callable {
...
//> Classes is-initializer-field
  ...
  XFunction(Stmt.Function declaration, Environment closure,
...
//> Classes bind-instance
  XFunction bind(XInstance instance) {
...
//> lox-function-bind-with-initializer
    return new XFunction(declaration, environment,
                           isInitializer);
//< lox-function-bind-with-initializer
  }
//< Classes bind-instance
